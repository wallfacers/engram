...
**维护者决定（2026-08-11）**：全量 1,986 口径（含 446 adversarial 拒答，靠拒答校准把
1,378 答对 + 拒答推到 90%）曾作为候选提出，被维护者拒绝——"换分母拿高分是投机倒把，没必要"。
**全量口径路径关闭。** 目标锁定 1,540 可答子集，90% = 1386/1540 纯答题正确；当前诚实带
1381（89.68%）。
