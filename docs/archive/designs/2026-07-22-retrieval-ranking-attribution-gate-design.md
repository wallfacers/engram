---
title: 归因门控的检索排序(retrieval-ranking, evidence-gated)— 设计
summary: 本文冻结 Feature 009 的归因门控排序设计；不描述当前产品路线或默认检索能力。
status: archived
audience: [maintainers, agents]
owner: engram-maintainers
last_reviewed: 2026-07-28
canonical_for: [design-009-retrieval-attribution]
tags: [archive, design, retrieval]
...
> **历史归档，不描述当前状态。** Feature 009 已收口；当前实验裁决请查看[实验裁决索引](../../evaluation/experiment-verdicts.md)。
...
诊断证据见[Single 与 Multi-hop 失败诊断](../evaluation/locomo-single-multihop-diagnosis-2026-07.md)、[Temporal T-4 分析](../evaluation/temporal-t4-analysis-2026-07.md)、[LoCoMo 实验台账](../evaluation/locomo-experiment-ledger-2026-07.md)和[记忆策略决策记录](../decisions/memory-strategy-2026-07.md)。
