---
title: 多查询检索:提质型深召回(query 分解 → 引擎 RRF 融合)— 设计
summary: 本文冻结 Feature 010 的多查询检索设计；不描述当前默认检索能力或未来承诺。
status: archived
audience: [maintainers, agents]
owner: engram-maintainers
last_reviewed: 2026-07-28
canonical_for: [design-010-multi-query]
...
> **历史归档，不描述当前状态。** Feature 010 已收口；当前实验裁决请查看[实验裁决索引](../../evaluation/experiment-verdicts.md)。
