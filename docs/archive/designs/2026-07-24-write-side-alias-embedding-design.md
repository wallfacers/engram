---
title: 写入侧表示 —— dual-index alias 向量(提质型深召回,第二枪)
summary: 本文冻结 Feature 011 的 alias 向量设计；不描述当前已出货的写入或检索能力。
status: archived
audience: [maintainers, agents]
owner: engram-maintainers
last_reviewed: 2026-07-28
canonical_for: [design-011-alias-embedding]
tags: [archive, design, embedding]
...
> **历史归档，不描述当前状态。** Feature 011 已收口；当前实验裁决请查看[实验裁决索引](../../evaluation/experiment-verdicts.md)。
