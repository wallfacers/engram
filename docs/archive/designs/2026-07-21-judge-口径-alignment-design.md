---
title: 设计:LoCoMo Judge 口径对齐(mem0-aligned)
summary: 本文冻结 Feature 007 的 judge 口径对齐设计；不描述当前待办或当前评测结果。
status: archived
audience: [maintainers, agents]
owner: engram-maintainers
last_reviewed: 2026-07-28
canonical_for: [design-007-judge-alignment]
tags: [archive, design, judge]
outcome: implemented
...
> **历史归档，不描述当前状态。** Feature 007 已实施；当前评测口径请查看[当前评测结果](../../evaluation/results.md)。
