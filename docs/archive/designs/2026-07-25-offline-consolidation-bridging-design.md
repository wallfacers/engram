---
title: 离线固结 · 跨 session 桥接合成（offline consolidation / bridging）
summary: 本文冻结 Feature 015 的离线固结设计；不描述当前已出货的 curation 或检索能力。
status: archived
audience: [maintainers, agents]
owner: engram-maintainers
last_reviewed: 2026-07-28
canonical_for: [design-015-consolidation]
tags: [archive, design, consolidation]
...
> **历史归档，不描述当前状态。** Feature 015 已收口；当前 curation 边界请查看[记忆系统架构](../../architecture/memory-system.md)。
