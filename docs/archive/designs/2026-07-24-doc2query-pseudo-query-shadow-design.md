---
title: 设计：写入侧 Doc2Query 伪查询影子向量（Feature 012）
summary: 本文冻结 Feature 012 的 Doc2Query 影子向量设计；不描述当前已出货的检索能力。
status: archived
audience: [maintainers, agents]
owner: engram-maintainers
last_reviewed: 2026-07-28
canonical_for: [design-012-doc2query]
tags: [archive, design, doc2query]
...
> **历史归档，不描述当前状态。** Feature 012 已收口；当前实验裁决请查看[实验裁决索引](../../evaluation/experiment-verdicts.md)。
