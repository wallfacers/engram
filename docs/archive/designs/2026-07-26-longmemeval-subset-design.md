---
title: LongMemEval 子集先行 · 跨 benchmark 复现 coverage≠answer
summary: 本文冻结 Feature 016 的 LongMemEval 子集设计；不描述当前 full 500 结果或最终研究结论。
status: archived
audience: [maintainers, agents]
owner: engram-maintainers
last_reviewed: 2026-07-28
canonical_for: [design-016-longmemeval]
tags: [archive, design, longmemeval]
outcome: inconclusive
superseded_by: docs/evaluation/results.md
feature: "016"
---

# LongMemEval 子集先行 · 跨 benchmark 复现 coverage≠answer

> **历史归档，不描述当前状态。** Feature 016 的子集设计已被 full 500 结果替代；请查看[当前评测结果](../../evaluation/results.md)。
