---
title: 答题侧时序推理契约 — 设计文档
summary: 本文冻结 Feature 014 的答题侧时序推理设计；不描述当前默认路线或完整能力状态。
status: archived
audience: [maintainers, agents]
owner: engram-maintainers
last_reviewed: 2026-07-28
canonical_for: [design-014-temporal-contract]
tags: [archive, design, temporal]
outcome: implemented
...
> **历史归档，不描述当前状态。** Feature 014 的相关结论已进入历史裁决；请查看[实验裁决索引](../../evaluation/experiment-verdicts.md)。
