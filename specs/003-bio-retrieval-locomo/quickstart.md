...
export EXTRACT_MODEL=gpt-5.6-luna  # 抽取候选 A（校准期 A/B vs sol 后冻结）
export EMBED_BASE_URL=http://127.0.0.1:11434/v1
export EMBED_MODEL=qwen3-embedding:0.6b
export LOCOMO_PRICE_TABLE='{"gpt-5.6-sol":{"in":1.25,"out":10.0},"gpt-5.6-luna":{"in":0.6,"out":4.8}}'
...
EXTRACT_MODEL=gpt-5.6-luna ./locomo-bench --data ... --run-dir .locomo-run/s0-extract-luna --repeats 5 --no-idk-retry
...
./locomo-bench --compare .locomo-run/s0-extract-luna .locomo-run/s0-extract-sol
