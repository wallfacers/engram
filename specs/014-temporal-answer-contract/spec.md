...
1. **Given** box 全本地栈 + canonical recipe + `--cat-top-k 1=150`(锚定现 ship 候选栈), **When** 跑 base / old-tplan / new-tplan 三臂 repeats=3, **Then** 得到每臂 category-2(n=321)准确率与逐题正误,用于配对检验。
