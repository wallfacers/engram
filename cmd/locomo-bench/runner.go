...
func answerPromptForOptionsWithTemporal(category int, forceAnswer, temporalAnswer bool) string {
	return answerPromptForRegime(category, forceAnswer, temporalAnswer)
}

// answerPromptForRegime selects the answer system prompt. Category- and
// temporal-specific answerable prompts are distinct scoring conventions, not
// per-category refinements.
func answerPromptForRegime(category int, forceAnswer, temporalAnswer bool) string {
...
func answerPromptForEval(category int, opt options) string {
	...
	return answerPromptForRegime(category, opt.forceAnswer, opt.temporalAnswerPrompt)
}
